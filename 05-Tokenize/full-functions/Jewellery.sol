...
import "./IERC20.sol";       // for accepting other erc20 token as paye method. [but not add yet]
import "./IShop.sol";        // talk with other shop or frenchays/forks
import "./ERC165.sol";       // need to talk other and track
import "./Libs.sol";
...
contract Jewellery is IShop, ERC165{
    ...
    // setup ============================================
    // all tokenized assets need name & symbol for showing on web3 wallet as well
    string private NAME; // tokenized shop name
    string private SYMBOL; // tokenized shop symbol
    ...
    uint256 private _shopBalance; // balance on receive()
    enum JEWLLARYTYPE {
        //  0         1       2     3        4
    ...
    // init ============================================
    constructor(string memory shopName_, string memory shopSymbol_) 
    {
        SHOP = _msgSender();
        _id = 0;
        NAME = shopName_;
    ...
    // assist ============================================
	function shopName() external view virtual returns (string memory)
    {
        return NAME;
    }

	function shopSymbol() external view virtual returns (string memory)
    {
        return SYMBOL;
    }
...
// https://github.com/mosi-sol/live-contract-s3/blob/main/05-Tokenize
